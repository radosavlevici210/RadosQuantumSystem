    ...
    <div className="w-80 bg-gray-800 border-r border-gray-700 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <a href="/" className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
          location === '/' 
            ? 'bg-quantum-indigo bg-opacity-20 text-quantum-teal quantum-glow' 
            : 'text-gray-300 hover:bg-gray-700'
        }`}>
          <i className="fas fa-project-diagram"></i>
          <span>Quantum Circuit</span>
        </a>
        <a href="/analytics" className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
          location === '/analytics' 
            ? 'bg-quantum-indigo bg-opacity-20 text-quantum-teal quantum-glow' 
            : 'text-gray-300 hover:bg-gray-700'
        }`}>
        ...
        <a href="/network" className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
          location === '/network' 
            ? 'bg-quantum-indigo bg-opacity-20 text-quantum-teal quantum-glow' 
            : 'text-gray-300 hover:bg-gray-700'
        }`}>
        ...
        <a href="/security" className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
          location === '/security' 
            ? 'bg-quantum-indigo bg-opacity-20 text-quantum-teal quantum-glow' 
            : 'text-gray-300 hover:bg-gray-700'
        }`}>
        ...
        <a href="/settings" className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
          location === '/settings' 
            ? 'bg-quantum-indigo bg-opacity-20 text-quantum-teal quantum-glow' 
            : 'text-gray-300 hover:bg-gray-700'
        }`}>
